...
const DataScreen = ({navigation}) => {
  return (
    <View style={{flex:1}}>
      ...
      <View style={{height:'25%',width:'100%',borderRadius:10,
       backgroundColor:'#fff',marginTop:'80%'}}>
      ...
      backgroundColor:'lightblue',marginTop:'20%'}}>
      <View style={{flexDirection:'row', justifyContent:'space-around'}}>
      ...
      <TouchableOpacity style={{backgroundColor:'#036eb6', height:50, width:'99%',
