...
const ChangeBeatScreen = ({navigation}) => {
  return (
    <View>
      <HeaderScreen3 />
      ...
      <View>
      <TouchableOpacity style={styles.btnn} onPress={()=>navigation.navigate('TodayPerformanceScreen')}>
      <Text style={{fontWeight:'bold',color:'#fff'}}>NO BEAT SELECTED</Text>
...
export default ChangeBeatScreen
